...
public class LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification extends LIBORVolatilityModel {
	 ...
	 */
	public LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(final RandomVariableFactory abstractRandomVariableFactory, final TimeDiscretization timeDiscretization, final TimeDiscretization liborPeriodDiscretization, final RandomVariable a, final RandomVariable b, final RandomVariable c, final RandomVariable d, final boolean isCalibrateable) {
	 ...
	 * @param isCalibrateable Set this to true, if the parameters are available for calibration.
	 */
	public LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(final TimeDiscretization timeDiscretization, final TimeDiscretization liborPeriodDiscretization, final RandomVariable a, final RandomVariable b, final RandomVariable c, final RandomVariable d, final boolean isCalibrateable) {
	 ...
	 * @param isCalibrateable Set this to true, if the parameters are available for calibration.
	 */
	public LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(final RandomVariableFactory abstractRandomVariableFactory, final TimeDiscretization timeDiscretization, final TimeDiscretization liborPeriodDiscretization, final double a, final double b, final double c, final double d, final boolean isCalibrateable) {
		super(timeDiscretization, liborPeriodDiscretization);
		this.abstractRandomVariableFactory = abstractRandomVariableFactory;
	 ...
	 * @param isCalibrateable Set this to true, if the parameters are available for calibration.
	 */
	public LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(final TimeDiscretization timeDiscretization, final TimeDiscretization liborPeriodDiscretization, final double a, final double b, final double c, final double d, final boolean isCalibrateable) {
		this(new RandomVariableFromArrayFactory(), timeDiscretization, liborPeriodDiscretization, a, b, c, d, isCalibrateable);
	}
	...
	@Override
	public LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification getCloneWithModifiedParameter(final RandomVariable[] parameter) {
		if(!isCalibrateable) {
			return this;
		}

		return new LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(
	...
	public RandomVariable getVolatility(final int timeIndex, final int liborIndex) {
		...
		synchronized (volatilityLazyInitLock) {
			...
			} // NB:: getTimeDiscretization ritorna la timeDiscretization ovvero la discretizzaz. del SIMULATION TIME
...
//---> MERCURIO
	...
	public LIBORVolatilityModel getCloneWithModifiedData(final Map<String, Object> dataModified) {
		...
		final LIBORVolatilityModel newModel = new LIBORVolatilityModelFourParameterExponentialFormWithMercurioModification(abstractRandomVariableFactory, timeDiscretization, liborPeriodDiscretization, a, b, c, d, isCalibrateable);
		return newModel;
	}
